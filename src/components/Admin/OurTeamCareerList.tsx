...
const OurTeamCareerList = () => {
  ...
  const fetchTeam = async () => {
    try {
      const response = await axios.get("https://intellisurgetechnologies.onrender.com/api/OurTeamCareer/");
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      await axios.delete(`https://intellisurgetechnologies.onrender.com/api/OurTeamCareer/${id}/`);
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button asChild>
          <Link to="/admin/OurTeamCareer/add">Add New Member</Link>
        </Button>
      </div>
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => navigate(`/admin/OurTeamCareer/edit/${member.id}`)}
...
export default OurTeamCareerList;
